import { asleepWhileTheyBoost, doomedReplacement, futileSubstitute, statusIntoKnockout, destinyBondTrade, repeatedSelfEffect, certainlyFails, endeavorTooEarly, pickedOffOnArrival, pivotIntoKnockout, savingTheDoomed, sleeperThrownAway, setupIntoSleep, baitedCrash, chargeWontFire, seededAndLosing, freeKnockoutPassedUp, healAtFullHP, setupIntoPhazer, setupRaceLost, futileUnawareSetup, dominatedMoves, healingOverAKnockout, outhealed, recoilIntoRecovery, statusThatHelpsThem, encoredIntoNothing, futileProtect, lethalPriority, lockedAndLosing, lockedIntoImmunity, needlessGamble, preserveSoleDefensiveAnswer, redundantTera } from '../strategy/dominance.js';
