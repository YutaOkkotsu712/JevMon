...
// Branch damage rolls at every depth, as mcts.rs does: past a fixed depth the average roll made coin-flip knockouts certain.
const MCTS_DAMAGE_BRANCH_DEPTH: u8 = u8::MAX;
